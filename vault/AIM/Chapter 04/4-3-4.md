...
> **Gist:** At a non-towered airport the segmented circle shows the pattern: the wind sock or tee gives wind, a tetrahedron (small end into the landing direction) gives landing direction, landing strip indicators show runway alignment and traffic pattern indicators show which runways use right traffic. Turns are to the left unless an indicator says right. When two aircraft are approaching to land, the lower one has the right-of-way but may not cut in front of one on final.
> **Why it matters:** The examiner will show you a segmented circle diagram and ask which runway and which direction of traffic it calls for.
> **Numbers:** Wind cone: large end into the wind · Tetrahedron: small end points to the landing direction · Left turns unless the indicator shows right · Lower aircraft has the right-of-way, but no cutting in
> **Watch out:** The tetrahedron may be set by wind or locked by the airport; the AIM warns not to use it for anything but landing direction.
> **ACS:** [[PA.II.D#^pa-ii-d-k4|PA.II.D.K4]] · [[PA.III.B#^pa-iii-b-k2|PA.III.B.K2]] — **Stage:** pre-solo
