...
change: 3
canonical_hash: "sha256:12624421c04eb21372f83e95d2ebbc19e4278dbfab6265ce379ba2361364318d"
generated: true
...
> [!info] Source
> FAA Aeronautical Information Manual, Basic with Change 1, 2 and 3 (effective 2026-07-09) — [view on FAA](https://www.faa.gov/air_traffic/publications/atpubs/aim_html/chap4_section_1.html#4-1-15)

> [!study] Private Pilot study aid — curated, not official text
> **Gist:** Radar traffic information service ('flight following'): the controller points out targets that may conflict, by clock position, distance, direction of travel and type and altitude if known. Clock position is based on your track, so with a crab the traffic appears offset. It is entirely at the controller's discretion, does not include vectors away from traffic unless you ask, and never relieves you of see-and-avoid. Monitor the frequency continuously and, when you no longer want the service, tell the controller before switching and squawk 1200.
> **Why it matters:** The examiner asks how to request, use and terminate flight following, and what a clock call really means.
> **Numbers:** You still see and avoid · Traffic by clock position · Ending the service: tell ATC, then squawk 1200
> **Watch out:** The clock position is relative to your ground track, not your heading; crabbing 20 degrees right puts 12 o'clock traffic at about 11 o'clock out the window.
> **Watch out:** Uncorrected Mode C altitude in a traffic call is 'indicated' and may be wrong; look above and below the reported altitude.
...
- **c.** Issuance of Traffic Information. Traffic information will include the following concerning a target which may constitute traffic for an aircraft that is:
    ...
    - **1.** Radar identified
        ...
        - **(b)** When rapidly maneuvering civil test or military aircraft prevent accurate issuance of traffic as in (a) above, specify the direction from an aircraft's position in terms of the eight cardinal compass points (N, NE, E, SE, S, SW, W, NW). This method must be terminated at the pilot's request.
...
- **d.** The examples depicted in the following figures point out the possible error in the position of this traffic when it is necessary for a pilot to apply drift correction to maintain this track. This error could also occur in the event a change in course is made at the time radar traffic information is issued.
    ...
    **FIG 4-1-15** *Induced Error in Position of Traffic*

    ![[aim0401_fig79_recovered.svg|Induced Error in Position of Traffic]]
    ...
    **FIG 4-1-15** *Induced Error in Position of Traffic*
    ...
    ![[aim0401_fig80_recovered.svg|Induced Error in Position of Traffic]]
