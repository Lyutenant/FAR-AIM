...
> **Gist:** Airports may have wind shear and microburst detection (LLWAS, TDWR, WSP, ITWS) whose alerts controllers relay: for LLWAS as airport wind followed by a boundary wind, and for the newer systems as a microburst or wind shear alert with the expected airspeed loss and location on final.
> **Why it matters:** If you ever hear 'microburst alert, 40 knot loss, 3 mile final' you should know what it means before it is said.
> **Numbers:** LLWAS alert format · Microburst alert format
> **ACS:** [[PA.III.B#^pa-iii-b-r3|PA.III.B.R3]] · [[PA.IV.A#^pa-iv-a-r2b|PA.IV.A.R2b]] — **Stage:** solo-xc
...
- [[4-1-23|AIM 4-1-23 — Weather Systems Processor]]
