...
> **Gist:** Squawk 1200 for VFR with altitude reporting on; the transponder and ADS-B Out stay on from pushback to parking, ident only when asked, never squawk 7777, and avoid passing through 7500, 7600 or 7700 when changing codes.
> **Why it matters:** The emergency codes are on every written; the ground-operation rule is a common oral question.
> **Numbers:** VFR: 1200 · 7500 hijack, 7600 lost communications, 7700 emergency · Never 7777 (military interceptors)
> **ACS:** [[PA.III.A#^pa-iii-a-k4|PA.III.A.K4]] · [[PA.VI.B#^pa-vi-b-k4|PA.VI.B.K4]] — **Stage:** pre-solo
