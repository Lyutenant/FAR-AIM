...
change: 3
canonical_hash: "sha256:ed3fe818a36e7bd758a4aa95dc5ddc8fb0654a0a6e92169af5f2489b016f5263"
generated: true
...
# AIM 5-6-13 — Interception Procedures

> [!info] Source
> FAA Aeronautical Information Manual, Basic with Change 1, 2 and 3 (effective 2026-07-09) — [view on FAA](https://www.faa.gov/air_traffic/publications/atpubs/aim_html/chap5_section_6.html#5-6-13)

> [!study] Private Pilot study aid — curated, not official text
> **Gist:** Military interception: NORAD fighters or helicopters may intercept to identify, track, inspect, divert or establish communications with an aircraft. Monitor 121.5 (guard); if intercepted, contact ATC immediately, follow the visual signals, and squawk 7700 unless told otherwise. Fighters approach from behind; if you do not comply they may fly across your path to divert you. Comply until positively released.
> **Why it matters:** The ACS lists interception procedures as a knowledge element, and TFR violators meet them for real.
> **Numbers:** Monitor guard · Call on guard with identity, position, nature of flight · Squawk 7700 · Comply until released
...
- **b.** Fighter intercept phases (see FIG 5-6-1).
    ...
    - **3.** Post Intercept Phase.\
        ...
        **FIG 5-6-13** *Intercept Procedures*

        ![[aim0506_Auto2.png|Intercept Procedures]]
...
- **c.** Helicopter Intercept phases (see FIG 5-6-2).
    ...
    - **3.** Post Intercept Phase. Visual signaling devices may be used in an attempt to communicate with the intercepted aircraft. Visual signaling devices may include, but are not limited to, LED scrolling signboards or blue flashing lights. If compliance is not attained through the use of radios or signaling devices, standard ICAO intercept signals (TBL 5-6-1) may be employed. In order to maintain safe aircraft separation, it is incumbent upon the pilot of the intercepted aircraft not to fall into a trail position (directly behind the helicopter) if instructed to follow the helicopter. This is because the helicopter pilot may lose visual contact with the intercepted aircraft.
        ...
        **FIG 5-6-13** *Helicopter Intercept Procedures*

        ![[aim0506_Auto1.png|Helicopter Intercept Procedures]]
...
- [[5-6-14|AIM 5-6-14 — Interception Signals]]
