...
change: 3
canonical_hash: "sha256:2bb91e39844a23b89170c2e0f0be3cffc5ef2e4c9a88d3cbc521301d4b214fbc"
generated: true
...
> **Gist:** Mandatory instruction signs are white on red: runway holding position signs (the numbers are arranged so the runway threshold on the left is the left number, e.g. 15-33), runway approach-area holding signs, ILS critical area signs, and the no-entry sign. They mark where you must stop without clearance.
> **Why it matters:** Reading 15-33 correctly tells you which way each runway's threshold lies, which is what the examiner is testing when they show you the sign.
> **Numbers:** White on red · 15-33: threshold 15 to the left, 33 to the right
> **Watch out:** A sign with only one runway number means you are at the beginning of that takeoff runway, not that the other direction does not exist.
