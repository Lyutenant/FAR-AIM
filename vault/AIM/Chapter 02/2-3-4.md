...
> **Gist:** Taxiway markings are yellow: a single continuous centerline, an enhanced centerline of dashes on both sides for 150 ft before a runway holding position, a continuous double yellow edge line you must not cross, a dashed double yellow edge line you may cross onto usable pavement, and surface-painted signs and geographic position markings at some airports.
> **Why it matters:** The enhanced centerline is the runway-incursion warning painted under your nose; knowing what it means is an ACS risk item.
> **Numbers:** Centerline: single continuous yellow line · Enhanced centerline runs 150 ft before the hold line · Continuous double yellow edge: pavement not for aircraft
> **Watch out:** Staying on the centerline does not guarantee wingtip clearance; the AIM says so explicitly.
