...
change: 3
canonical_hash: "sha256:b838645e008bf99a77b9421af03820b1e6af88a125e7e8cfe40dec744dc61c84"
generated: true
...
> [!info] Source
> FAA Aeronautical Information Manual, Basic with Change 1, 2 and 3 (effective 2026-07-09) — [view on FAA](https://www.faa.gov/air_traffic/publications/atpubs/aim_html/chap7_section_1.html#7-1-4)

> [!study] Private Pilot study aid — curated, not official text
> **Gist:** The Graphical Forecasts for Aviation website (aviationweather.gov/gfa) replaced the text area forecast: gridded clouds, ceiling and visibility, precipitation, thunderstorms, winds, turbulence and icing from 14 hours in the past to 15 hours ahead, with observation tabs for METARs, PIREPs and radar and satellite, plus static Aviation Cloud Forecast and Aviation Surface Forecast images.
> **Why it matters:** The examiner will expect you to have used the GFA for your cross-country plan and to know it superseded the area forecast.
> **Numbers:** 14 hours back, 15 hours ahead · Replaces the area forecast
> **ACS:** [[PA.I.C#^pa-i-c-k2|PA.I.C.K2]] · [[PA.I.C#^pa-i-c-k2d|PA.I.C.K2d]] — **Stage:** solo-xc
...
- **b.** Weather Products.
    ...
    - **4.** GFA Static Images. Some users with limited internet connectivity may access static images via the Aviation Weather Center (AWC) Decision Support Imagery at: https://aviationweather.gov/graphics/. There are two static graphical images available, titled Aviation Cloud Forecast and Aviation Surface Forecast. The Aviation Cloud Forecast provides cloud coverage, bases, layers, and tops with AIRMETs for mountain obscuration and AIRMETs for icing overlaid. The Aviation Surface Forecast provides visibility, weather phenomena, and winds (including wind gusts) with AIRMETs for instrument flight rules conditions and AIRMETs for sustained surface winds of 30 knots or more overlaid. These images are presented on ten separate maps providing forecast views for the entire contiguous United States (U.S.) on one and nine regional views which provide more detail for the user. They are updated every 3 hours and provide forecast snapshots for 3, 6, 9, 12, 15, and 18 hours into the future. (See FIG 7-1-2 and FIG 7-1-3.)
        ...
        **FIG 7-1-4** *Aviation Surface Forecast*

        ![[aim0701_At_Anchor3.png|Aviation Surface Forecast]]

        **FIG 7-1-4** *Aviation Cloud Forecast*

        ![[aim0701_At_Anchor2.png|Aviation Cloud Forecast]]
