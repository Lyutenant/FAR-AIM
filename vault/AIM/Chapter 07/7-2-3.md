...
> **Gist:** Altimeter procedures: on the ground, a reading 75 ft or more off field elevation makes the altimeter questionable. Flying from high pressure into low without resetting puts you closer to the ground than indicated, about 1,000 ft per inch of error. Below 18,000 ft set a station within 100 nm; above 31.00 inches a NOTAM has everyone set 31.00 en route, with no extra restrictions on VFR aircraft; at 18,000 ft and above set 29.92, and the lowest usable flight level rises as pressure falls (FL180 at 29.92 or higher, FL190 down to 28.92, FL200 below that).
> **Why it matters:** The 75 ft ground check and 'high to low, look out below' are checkride staples.
> **Numbers:** Ground check: 75 ft or more is questionable · High to low, look out below · Station within 100 nm below 18,000 ft · VFR: no extra restrictions above 31.00 · Lowest usable flight level at 29.92 or higher: 180
> **Mnemonic (training-community, not FAA):** High to low, look out below (and hot to cold, look out below).
> **ACS:** [[PA.I.G#^pa-i-g-k1h|PA.I.G.K1h]] · [[PA.I.D#^pa-i-d-k2|PA.I.D.K2]] — **Stage:** solo-xc
...
- **c.** The aircraft cruising altitude or flight level is maintained by referencing the barometric altimeter. Procedures for setting altimeters during high and low barometric pressure events must be set using the following procedures:
    ...
    - **2.** At or above 18,000 feet MSL. All operators will set 29.92 “Hg. (standard setting) in the barometric altimeter. The lowest usable flight level is determined by the atmospheric pressure in the area of operation as shown in TBL 7-2-1. Air Traffic Control (ATC) will assign this flight level.
        ...
        **TBL 7-2-3** *Lowest Usable Flight Level*
        ...
        <table>
        <thead>
        <tr><th><p>Altimeter Setting (Current Reported)</p></th><th><p>Lowest Usable Flight Level</p></th></tr>
        </thead>
        <tbody>
        <tr><td><p>29.92 or higher</p></td><td><p>180</p></td></tr>
        <tr><td><p>29.91 to 28.92</p></td><td><p>190</p></td></tr>
        <tr><td><p>28.91 to 27.92</p></td><td><p>200</p></td></tr>
        </tbody>
        </table>
    ...
    - **3.** When the minimum altitude per 14 CFR section 91.159 and 14 CFR section 91.177 is above 18,000 feet MSL, the lowest usable flight level must be the flight level equivalent of the minimum altitude plus the number of feet specified in TBL 7-2-2. ATC will accomplish this calculation.
        ...
        **TBL 7-2-3** *Lowest Flight Level Correction Factor*
        ...
        <table>
        <thead>
        <tr><th><p>Altimeter Factor</p></th><th><p>Correction Factor</p></th></tr>
        </thead>
        <tbody>
        <tr><td><p>29.92 or higher</p></td><td><p>None</p></td></tr>
        <tr><td><p>29.91 to 29.42</p></td><td><p>500 feet</p></td></tr>
        <tr><td><p>29.41 to 28.92</p></td><td><p>1000 feet</p></td></tr>
        <tr><td><p>28.91 to 28.42</p></td><td><p>1500 feet</p></td></tr>
        <tr><td><p>28.41 to 27.92</p></td><td><p>2000 feet</p></td></tr>
        <tr><td><p>27.91 to 27.42</p></td><td><p>2500 feet</p></td></tr>
        </tbody>
        </table>
