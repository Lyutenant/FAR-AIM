...
> **Gist:** Preflight briefings from Flight Service: a Standard briefing when you have had no prior information (adverse conditions, a 'VFR flight not recommended' advisory when the briefer judges VFR doubtful, synopsis, current conditions if departing within 2 hours, en route forecast, destination forecast, winds aloft in knots and degrees true, NOTAMs, ATC delays, and on request SUA status, density altitude and RAIM); an Abbreviated briefing to update or fill gaps; and an Outlook briefing when departure is six or more hours away.
> **Why it matters:** The three briefing types and the meaning of 'VFR flight not recommended' are standard knowledge-test and oral questions.
> **Numbers:** Standard briefing · 'VFR flight not recommended' is advisory · Current conditions omitted if departure is beyond 2 hours · Winds aloft: knots and degrees true · Outlook briefing: six or more hours ahead
> **Watch out:** Winds aloft are true, not magnetic; convert before computing headings.
> **Watch out:** MOA, MTR and warning-area NOTAMs are 'on request' items; ask for them.
> **ACS:** [[PA.I.C#^pa-i-c-k1|PA.I.C.K1]] · [[PA.I.C#^pa-i-c-k2|PA.I.C.K2]] · [[PA.I.C#^pa-i-c-r1|PA.I.C.R1]] — **Stage:** solo-xc
