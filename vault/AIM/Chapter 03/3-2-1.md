...
> **Gist:** Controlled airspace basics: ATC service is provided to IFR flights and to VFR flights according to the class. It is the pilot's responsibility to meet the clearance or communication requirement before entering Class B, C or D, even while receiving radar advisories. Traffic advisories are workload permitting; safety alerts are mandatory. Ultralights, unmanned balloons and parachute jumps need authorization in the controlled classes.
> **Why it matters:** The 'responsibility stays with the pilot' sentence is why a flight-following handoff is not a clearance into Class B.
> **Numbers:** You must meet the entry requirement yourself · Safety alerts are mandatory · Traffic advisories are workload permitting
> **Watch out:** Being on flight following with approach does not clear you into Class B; you need the words 'cleared into the Class Bravo'.
> **ACS:** [[PA.I.E#^pa-i-e-k1|PA.I.E.K1]] · [[PA.I.E#^pa-i-e-r1|PA.I.E.R1]] — **Stage:** solo-xc
