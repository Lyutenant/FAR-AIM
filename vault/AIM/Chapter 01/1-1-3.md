...
change: 3
canonical_hash: "sha256:2c2187638c73dc2a31766cd1bfedb9f8e6c2c7632629845ce767c77981a3e5da"
generated: true
title: "VHF Omni-directional Range (VOR)"
aliases:
  - "AIM 1-1-3"
...
# AIM 1-1-3 — VHF Omni-directional Range (VOR)

> [!info] Source
> FAA Aeronautical Information Manual, Basic with Change 1, 2 and 3 (effective 2026-07-09) — [view on FAA](https://www.faa.gov/air_traffic/publications/atpubs/aim_html/chap1_section_1.html#1-1-3)

> [!study] Private Pilot study aid — curated, not official text
> **Gist:** The VOR: 108.0 to 117.95 MHz, line-of-sight, course accuracy of about plus or minus 1 degree, identified only by its Morse code or recorded voice ident. Propeller RPM can make the needle wander up to 6 degrees. The VOR Minimum Operational Network keeps enough stations that a MON airport with a non-GPS approach is always within 100 nm and VOR coverage is continuous at 5,000 ft AGL.
> **Why it matters:** VOR navigation is a checkride task, and the identification rule is the one examiners ask first: you have not tuned a VOR until you have heard its ident.
> **Numbers:** 108\.0 to 117.95 MHz · Identify by Morse code or voice ident only · Course accuracy about plus or minus 1 degree · MON airport within 100 nm
> **Watch out:** Hearing a Flight Service voice on the VOR frequency is not identification; many FSSs transmit over several VORs with different names.
> **Watch out:** A VOR without an ident is out of service even if the needle looks alive.
> **ACS:** [[PA.VI.B#^pa-vi-b-k1|PA.VI.B.K1]] · [[PA.VI.D#^pa-vi-d-k1|PA.VI.D.K1]] — **Stage:** solo-xc
