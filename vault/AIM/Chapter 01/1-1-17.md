...
> **Gist:** GPS for pilots: the constellation is designed so at least five satellites are visible, four are needed for a 3D position, and RAIM needs five (or four plus baro-aiding) to detect a bad satellite. For VFR the AIM's cautions are the point: VFR and hand-held receivers have no RAIM alerting, databases need not be current for VFR but should be, antenna placement matters, and you must not rely on GPS alone. VFR waypoints are five-letter names starting with VP, not for use with ATC and not allowed on IFR flight plans. The IFR half covers approved equipment, database and approach requirements.
> **Why it matters:** The examiner will ask what your tablet GPS cannot do; the answer is RAIM and integrity, and the AIM says so in plain words.
> **Numbers:** Four satellites for a 3D fix · RAIM needs 5 satellites, or 4 with baro-aiding · VFR and hand-held units have no RAIM alerting · No database currency requirement for VFR · Do not rely on GPS alone · VFR waypoints are not for IFR flight plans
> **Watch out:** An outdated database around Class B or a TFR can show airspace that has moved; verify waypoints against a current chart.
> **Watch out:** Do not fly a mountain pass from VFR waypoint to VFR waypoint; the points mark entries, not a path.
> **ACS:** [[PA.VI.B#^pa-vi-b-k2|PA.VI.B.K2]] · [[PA.VI.B#^pa-vi-b-r3|PA.VI.B.R3]] · [[PA.VI.B#^pa-vi-b-r4|PA.VI.B.R4]] — **Stage:** solo-xc
...
- [[1-1-18|AIM 1-1-18 — Wide Area Augmentation System (WAAS)]]
- [[5-5-16|AIM 5-5-16 — RNAV and RNP Operations]]
- [[5-1-16|AIM 5-1-16 — RNAV and RNP Operations]]
