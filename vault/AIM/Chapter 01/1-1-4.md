...
> **Gist:** How to check a VOR receiver: a VOT test signal reads 0 degrees FROM or 180 TO; ground checkpoints allow plus or minus 4 degrees, airborne checkpoints and airway checks plus or minus 6, and two independent receivers checked against each other may differ by 4 degrees. Checkpoint and VOT locations are in the Chart Supplement, and the check is required before IFR flight by § 91.171.
> **Why it matters:** The tolerances are a knowledge-test staple, and the VOT is the easiest thing to check on a taxi-out at a big airport.
> **Numbers:** Ground check 4 degrees, airborne 6 · Dual receivers: 4 degrees between them · Airway check point: more than 20 nm from the VOR
> **Watch out:** The VOT reads 0 FROM or 180 TO regardless of where you are on the airport; a different reading is receiver error, not position.
> **Mnemonic (training-community, not FAA):** VOT: 0 FROM, 180 TO. Ground 4, air 6, dual 4.
> **ACS:** [[PA.VI.B#^pa-vi-b-k1|PA.VI.B.K1]] — **Stage:** checkride
