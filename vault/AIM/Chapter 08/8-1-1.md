...
change: 3
canonical_hash: "sha256:a3e19fedb9be80f763593dfa149c56b2bdc4b138aa83f9cc54f4d0fd347fddff"
generated: true
...
> [!info] Source
> FAA Aeronautical Information Manual, Basic with Change 1, 2 and 3 (effective 2026-07-09) — [view on FAA](https://www.faa.gov/air_traffic/publications/atpubs/aim_html/chap8_section_1.html#8-1-1)

> [!study] Private Pilot study aid — curated, not official text
> **Gist:** Fitness for flight: a medical certificate, and the § 61.53 rule that a known disqualifying condition grounds you even with one. Do not fly with any illness; do not fly on medication unless the FAA approves it; alcohol impairs with as little as one drink and is detectable for at least 3 hours, the rule is 8 hours bottle to throttle and you may still be impaired after that; fatigue (acute and chronic), sleep apnea, stress and emotional upset each degrade judgment. The FAA's personal checklist: I'M SAFE, not impaired by Illness, Medication, Stress, Alcohol, Fatigue, Emotion.
> **Why it matters:** IMSAFE is the aeromedical part of every checkride oral and this paragraph is where it comes from.
> **Numbers:** One drink impairs, detectable 3 hours · 8 hours bottle to throttle · No flying with any illness · No medication unless approved · The personal checklist
> **Watch out:** Eight hours is a floor, not a guarantee: the AIM says a pilot may still be under the influence 8 hours after moderate drinking, and § 91.17 also sets 0.04 percent blood alcohol.
> **Watch out:** Over-the-counter antihistamines and cold remedies count as medication that affects the faculties.
> **Mnemonic (training-community, not FAA):** I'M SAFE: Illness, Medication, Stress, Alcohol, Fatigue, Emotion.
> **ACS:** [[PA.I.H#^pa-i-h-k1|PA.I.H.K1]] · [[PA.I.H#^pa-i-h-k2|PA.I.H.K2]] · [[PA.I.H#^pa-i-h-k3|PA.I.H.K3]] — **Stage:** pre-solo
...
- **e.** Fatigue.
    ...
    - **4.** OBSTRUCTIVE SLEEP APNEA (OSA). OSA is now recognized as an important preventable factor identified in transportation accidents. OSA interrupts the normal restorative sleep necessary for normal functioning and is associated with chronic illnesses such as hypertension, heart attack, stroke, obesity, and diabetes. Symptoms include snoring, excessive daytime sleepiness, intermittent prolonged breathing pauses while sleeping, memory impairment and lack of concentration. There are many available treatments which can reverse the day time symptoms and reduce the chance of an accident. OSA can be easily treated. Most treatments are acceptable for medical certification upon demonstrating effective treatment. If you have any symptoms described above, or neck size over 17 inches in men or 16 inches in women, or a body mass index greater than 30 you should be evaluated for sleep apnea by a sleep medicine specialist.\
        (https://www.cdc.gov/healthyweight/assessing/bmi/adult\_bmi/english\_bmi\_calculator/bmi\_calculator.html) With treatment you can avoid or delay the onset of these chronic illnesses and prolong a quality life.
...
- **i.** PERSONAL CHECKLIST. I'm physically and mentally safe to fly; not being impaired by:
    ...
    <table>
    <thead>
    <tr><th><p>Illness</p></th></tr>
    </thead>
    <tbody>
    <tr><td><p>Medication</p></td></tr>
    <tr><td></td></tr>
    <tr><td><p>Stress</p></td></tr>
    <tr><td><p>Alcohol</p></td></tr>
    <tr><td><p>Fatigue</p></td></tr>
    <tr><td><p>Emotion</p></td></tr>
    </tbody>
    </table>

## Explicit Cross-References

- [[Part 67|14 CFR Part 67]]
