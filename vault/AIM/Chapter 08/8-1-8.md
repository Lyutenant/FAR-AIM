...
change: 3
canonical_hash: "sha256:c84a82f976df2e0d9827911c9110478b25cc26e939f431bae198ca2149702de7"
generated: true
title: "Judgment Aspects of Collision Avoidance"
aliases:
  - "AIM 8-1-8"
...
> [!info] Source
> FAA Aeronautical Information Manual, Basic with Change 1, 2 and 3 (effective 2026-07-09) — [view on FAA](https://www.faa.gov/air_traffic/publications/atpubs/aim_html/chap8_section_1.html#8-1-8)

> [!study] Private Pilot study aid — curated, not official text
> **Gist:** Collision-avoidance judgment: use the horizon to judge relative altitude (above the horizon means higher), know the right-of-way rules so you can act, expect the other pilot to maneuver too, and treat any target with no relative motion that grows in size as a collision course. High-hazard areas are airways near VORs and surface areas; most collisions happen in good weather; keep the windshield clean, cockpit organized, lights on, and use ATC advisories.
> **Why it matters:** 'No relative motion means collision course' is the single most useful sentence for see-and-avoid.
> **Numbers:** No relative motion: collision course · Above the horizon means higher · Most collisions in good weather · Lights on
> **ACS:** [[PA.XI.A#^pa-xi-a-r1|PA.XI.A.R1]] · [[PA.IV.A#^pa-iv-a-r4|PA.IV.A.R4]] — **Stage:** pre-solo
