...
id: "cfr-14-121.467"
type: "regulation"
citation: "14 CFR § 121.467"
title_number: 14
part: 121
section: "121.467"
source: "ecfr"
source_version: "2026-09-03"
canonical_hash: "sha256:fc19ccd97fd535beb1a2a29d9e335ad1f1d9ddb1ca6c2f395fa7f1bc64b33a3f"
generated: true
title: "Flight attendant duty period limitations and rest requirements: Domestic, flag, and supplemental operations"
aliases:
  - "§ 121.467"
  - "14 CFR 121.467"
...
> [!info] Source
> eCFR Title 14, issue 2026-09-03 — [view on eCFR](https://www.ecfr.gov/on/2026-09-03/title-14/section-121.467)
...
- **(a)** For purposes of this section—
    ...
    - *Duty period* means the period of elapsed time between reporting for an assignment involving flight time and release from that assignment by the certificate holder conducting domestic, flag, or supplemental operations. The time is calculated using either Coordinated Universal Time or local time to reflect the total elapsed time. ^def-duty-period

    - *Flight attendant* means an individual, other than a flight crewmember, who is assigned by a certificate holder conducting domestic, flag, or supplemental operations, in accordance with the required minimum crew complement under the certificate holder's operations specifications or in addition to that minimum complement, to duty in an aircraft during flight time and whose duties include but are not necessarily limited to cabin-safety-related responsibilities. ^def-flight-attendant

    - *Rest period* means the period free of all restraint or duty for a certificate holder conducting domestic, flag, or supplemental operations and free of all responsibility for work or duty should the occasion arise. ^def-rest-period
