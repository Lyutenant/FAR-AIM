...
id: "cfr-14-298.2"
type: "regulation"
citation: "14 CFR § 298.2"
title_number: 14
part: 298
section: "298.2"
source: "ecfr"
source_version: "2026-09-03"
canonical_hash: "sha256:51cb4138c1799da1d0fa5f77c8d0cf37d0aeb856022f74d51368e3626041daa9"
generated: true
title: "Definitions"
aliases:
  - "§ 298.2"
...
> [!info] Source
> eCFR Title 14, issue 2026-09-03 — [view on eCFR](https://www.ecfr.gov/on/2026-09-03/title-14/section-298.2)

## Official Text

As used in this part:

- *Air taxi operator* means an air carrier as established by § 298.3(a). ^def-air-taxi-operator

- *Air transportation* means interstate air transportation, foreign air transportation, or the transportation of mail by aircraft as defined by the Statute. 1 ^def-air-transportation
...
- *Aircraft-hours* means the airborne hours of aircraft computed from the moment an aircraft leaves the ground until it touches the ground at the end of a flight stage. ^def-aircraft-hours

- *Aircraft miles* means the miles (computed in airport-to-airport distances) for each flight stage actually completed, whether or not performed in accordance with the scheduled pattern. ^def-aircraft-miles

- *Certificated air carrier means* an air carrier holding a certificate issued under section 41102 of 49 U.S.C. Subtitle VII. ^def-certificated-air-carrier-means

- *Citizen of the United States* means: ^def-citizen-of-the-united-states
...
- *Departure* means takeoff from an airport. ^def-departure
...
- *Flight stage* means the operation of an aircraft from takeoff to landing. ^def-flight-stage

- *Large aircraft* means any aircraft originally designed to have a maximum passenger capacity of more than 60 seats or a maximum payload capacity of more than 18,000 pounds. ^def-large-aircraft

- *Maximum certificated takeoff weight* means the maximum takeoff weight authorized by the terms of the aircraft airworthiness certificate. 2 ^def-maximum-certificated-takeoff-weight
...
- *Maximum passenger capacity* means the maximum number of passenger seats for which an aircraft is configured. ^def-maximum-passenger-capacity

- *Maximum payload capacity* means: (1) The maximum certificated take-off weight of an aircraft, less the empty weight, 3 less all justifiable aircraft equipment, and less the operating load (consisting of minimum fuel load, oil, flight crew, steward's supplies, etc.). For purposes of this part, the allowance for the weight of the crew, oil, and fuel is as follows: ^def-maximum-payload-capacity
...
- *Revenue passenger-mile* means one revenue passenger transported one mile. Revenue passenger-miles are computed by multiplying the aircraft miles flown on each flight stage by the number of revenue passengers carried on that flight stage. ^def-revenue-passenger-mile

- *Revenue seat-miles available* means the aircraft-miles flown on each flight stage multiplied by the number of seats available for sale on that flight stage. ^def-revenue-seat-miles-available
...
- *Revenue ton-miles available* means the aircraft-miles flown on each flight stage multiplied by the number of pounds of aircraft capacity available for use on that stage and converted to ton-miles by dividing total pound-miles available by 2,000 pounds. ^def-revenue-ton-miles-available

- *Scheduled service* means transport service operated over routes pursuant to published flight schedules or pursuant to mail contracts with the U.S. Postal Service. ^def-scheduled-service

- *Small aircraft* means any aircraft originally designed to have a maximum passenger capacity of 60 seats or less or a maximum payload capacity of 18,000 pounds or less. ^def-small-aircraft

- *Small certificated air carrier* means an air carrier holding a certificate issued under section 41102 of 49 U.S.C. Subtitle VII that provides scheduled passenger air service within and between only the 50 States of the United States, the District of Columbia, the Commonwealth of Puerto Rico, and the U.S. Virgin Islands with small aircraft as defined in this section. ^def-small-certificated-air-carrier

- *Ton* means a short ton, i.e., 2,000 pounds. ^def-ton

- *Wet-Lease Agreement* means an agreement under which one carrier leases an aircraft with flight crew to another air carrier. ^def-wet-lease-agreement
