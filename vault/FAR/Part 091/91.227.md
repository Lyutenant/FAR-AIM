...
id: "cfr-14-91.227"
type: "regulation"
citation: "14 CFR § 91.227"
title_number: 14
part: 91
section: "91.227"
source: "ecfr"
source_version: "2026-09-03"
canonical_hash: "sha256:47e9a20f5162751d4a1d8f8fdcad2d0597a67bf109cf7b758c4f110bd225a03b"
generated: true
title: "Automatic Dependent Surveillance-Broadcast (ADS-B) Out equipment performance requirements"
aliases:
  - "§ 91.227"
  - "14 CFR 91.227"
...
> [!info] Source
> eCFR Title 14, issue 2026-09-03 — [view on eCFR](https://www.ecfr.gov/on/2026-09-03/title-14/section-91.227)

## Official Text

- **(a)** *Definitions.* For the purposes of this section:

    - *ADS-B Out* is a function of an aircraft's onboard avionics that periodically broadcasts the aircraft's state vector (3-dimensional position and 3-dimensional velocity) and other required information as described in this section. ^def-ads-b-out

    - *Navigation Accuracy Category for Position* (NACP) specifies the accuracy of a reported aircraft's position. ^def-navigation-accuracy-category-for-position

    - *Navigation Accuracy Category for Velocity* (NACV) specifies the accuracy of a reported aircraft's velocity. ^def-navigation-accuracy-category-for-velocity

    - *Navigation Integrity Category (NIC)* specifies an integrity containment radius around an aircraft's reported position. ^def-navigation-integrity-category-nic

    - *Position Source* refers to the equipment installed onboard an aircraft used to process and provide aircraft position (for example, latitude, longitude, and velocity) information. ^def-position-source

    - *Source Integrity Level (SIL)* indicates the probability of the reported horizontal position exceeding the containment radius defined by the NIC on a per sample or per hour basis. ^def-source-integrity-level-sil

    - *System Design Assurance (SDA)* indicates the probability of an aircraft malfunction causing false or misleading information to be transmitted. ^def-system-design-assurance-sda

    - *Total latency* is the total time between when the position is measured and when the position is transmitted by the aircraft. ^def-total-latency

    - *Uncompensated latency* is the time for which the aircraft does not compensate for latency. ^def-uncompensated-latency
...
\[Docket FAA-2007-29305, 75 FR 30194, May 28, 2010; Amdt. 91-314-A, 75 FR 37712, June 30, 2010, as amended by Amdt. 91-316, 75 FR 37712, June 30, 2010; Docket FAA-2023-1836, Amdt. 91-371, 88 FR 71477, Oct. 17, 2023]
