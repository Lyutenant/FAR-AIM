...
> **Gist:** For IFR in controlled airspace, the static system, each altimeter and the automatic altitude-reporting system must have been tested and inspected within the preceding 24 calendar months, and again after the static system is opened or the encoder worked on.
> **Why it matters:** The 24-month altimeter check is on the AV1ATE inspection list even though it is only required for IFR; the examiner will ask which inspections are VFR-required and which are not.
> **Numbers:** 24 calendar months (IFR)
> **Watch out:** This inspection is required only for IFR operations; a VFR-only airplane can legally skip it, but its encoder is still governed by § 91.413.
