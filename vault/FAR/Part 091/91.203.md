...
> [!info] Source
> eCFR Title 14, issue 2026-09-15 — [view on eCFR](https://www.ecfr.gov/on/2026-09-15/title-14/section-91.203)

> [!study] Private Pilot study aid — curated, not official text
> **Gist:** The paperwork that must be in the airplane: an appropriate and current airworthiness certificate, displayed at the cabin or cockpit entrance where it is legible, and an effective U.S. registration certificate (or the temporary alternatives the section lists). A fuel tank in the cabin needs a Form 337 aboard.
> **Why it matters:** It is the A and R of the ARROW checklist; § 91.9 supplies the O (operating limitations) and Part 23 or the POH the W (weight and balance).
> **Numbers:** Airworthiness certificate on board · Displayed and legible at the entrance
> **Watch out:** The registration expires; check the expiration date on the certificate, not just that it exists.
> **Watch out:** A photocopy of the airworthiness certificate does not satisfy the display requirement.
> **Mnemonic (training-community, not FAA):** ARROW: Airworthiness, Registration, Radio license (international only), Operating limitations, Weight and balance.
> **ACS:** [[PA.I.B#^pa-i-b-k1a|PA.I.B.K1a]] · [[PA.I.A#^pa-i-a-k4|PA.I.A.K4]] — **Stage:** pre-solo
