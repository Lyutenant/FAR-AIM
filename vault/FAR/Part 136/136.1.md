...
id: "cfr-14-136.1"
type: "regulation"
citation: "14 CFR § 136.1"
title_number: 14
part: 136
section: "136.1"
source: "ecfr"
source_version: "2026-09-03"
canonical_hash: "sha256:f9771ac05304fe15eded1f0dad3b113b1336c2be13280ebdc220f39c8df663ac"
generated: true
...
> [!info] Source
> eCFR Title 14, issue 2026-09-03 — [view on eCFR](https://www.ecfr.gov/on/2026-09-03/title-14/section-136.1)
...
- **(d)** For the purposes of this subpart the following definitions apply:
    ...
    - *Commercial air tour* means a flight conducted for compensation or hire in an airplane, powered-lift, or rotorcraft where a purpose of the flight is sightseeing. The FAA may consider the following factors in determining whether a flight is a commercial air tour for purposes of this subpart: ^def-commercial-air-tour
    ...
    - *Commercial Air Tour operator* means any person who conducts a commercial air tour. ^def-commercial-air-tour-operator

    - *Life preserver* means a flotation device used by an aircraft occupant if the aircraft ditches in water. If an inflatable device, it must be un-inflated and ready for its intended use once inflated. In evaluating whether a non-inflatable life preserver is acceptable to the FAA, the operator must demonstrate to the FAA that such a preserver can be used during an evacuation and will allow all passengers to exit the aircraft without blocking the exit. Each occupant must have the physical capacity to wear and inflate the type of device used once briefed by the commercial air tour operator. Seat cushions do not meet this definition. ^def-life-preserver

    - *Raw terrain* means any area on the surface, including water, devoid of any person, structure, vehicle, or vessel. ^def-raw-terrain

    - *Shoreline* means that area of the land adjacent to the water of an ocean, sea, lake, pond, river or tidal basin that is above the high water mark and excludes land areas unsuitable for landing such as vertical cliffs or land intermittently under water during the particular flight. ^def-shoreline

    - *Suitable landing area for rotorcraft* means an area that provides the operator reasonable capability to land in an emergency without causing serious injury to persons. These suitable landing areas must be site specific, designated by the operator, and accepted by the FAA. ^def-suitable-landing-area-for-rotorcraft
...
\[Docket FAA-1998-4521, 72 FR 6912, Feb. 13, 2007, as amended by Docket FAA-2022-1563, Amdt. 136-2, 88 FR 48091, July 26, 2023; Docket FAA-2023-1275, Amdt. 136-4, 89 FR 92488, Nov. 21, 2024]
