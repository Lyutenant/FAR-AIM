...
> [!info] Source
> eCFR Title 14, issue 2026-09-03 — [view on eCFR](https://www.ecfr.gov/on/2026-09-03/title-14/section-1206.507)
...
- **(b)** If the request is submitted on behalf of another person or organization (e.g., if an attorney is submitting a request on behalf of a client), the fee category will be determined by considering the underlying requester's identity and intended use of the information. The following table outlines the basic fee categories and applicable fees:
    ...
    | Educational and non-commercial scientific institutions | No | No | Yes (first 100 pages, or equivalent volume, without charge). |
    | Representative of news media requester | No | No | Yes (first 100 pages, or equivalent volume, without charge). |
    | All other requesters | Yes (first 2 hours without charge) | No | Yes (first 100 pages, or equivalent volume, without charge). |
